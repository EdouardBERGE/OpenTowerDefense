...
void main(int argc, char **argv) {
	...
	int i,explore=0,merge=0,create=0,mapedsk=0,putdata=0,getdata=0,putfile=0;
	char *format=NULL;
	char *infile=NULL,*outfile=NULL;
	char *datain=NULL;
	char *sep;
	int infile_offset=0,infile_size;
	int drop=0,add=0,droptrack=0,trackgap=0,trackfiller=0,repetition=0;
...
printf("repeat=%d\n",repetition);
	...
	*********************************************************************/
	 ...
	 * EDSK processing
	*********************************************************************/
	if (putfile+trackfiller+trackgap+droptrack+drop+add+getdata+putdata>1) {
